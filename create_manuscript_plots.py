...
if __name__ == "__main__":
    ...
    # create_pareto_1_16_leds_5_15cm() # uncomment to generate pareto plot for 1-16 LEDs and 5-15 cm
    # create_pareto_8_leds_13cm() # uncomment to generate pareto plot for 8 LEDs and 13 cm
